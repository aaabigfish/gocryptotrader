...
A full breakdown of all the supported wrapper funcs can be found [here.](https://github.com/aaabigfish/gocryptotrader/blob/master/exchanges/interfaces.go#L21)
