...
const (
	...
	restIndexResponse        = "<html>GoCryptoTrader RESTful interface. For the web GUI, please visit the <a href=https://github.com/aaabigfish/gocryptotrader/blob/master/web/README.md>web GUI readme.</a></html>"
