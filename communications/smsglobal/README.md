...
[![GoDoc](https://godoc.org/github.com/aaabigfish/gocryptotrader?status.svg)](https://godoc.org/github.com/aaabigfish/gocryptotrader/communications/smsglobal)
...
+ [Enable via configuration](https://github.com/aaabigfish/gocryptotrader/tree/master/config#enable-communications-via-config-example)

+ Individual package example below:
```go
import (
"github.com/aaabigfish/gocryptotrader/communications/smsglobal"
